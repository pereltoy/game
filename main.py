...
latters = ["א", "ב", "ג", "ד", "ה", "ו", "ז", "ח", "ט", "י",
           "כ", "ל", "מ", "נ", "ס", "ע", "פ", "צ", "ק", "ר", "ש", "ת"]
Latters = ["א", "ב", "ג", "ד", "ה", "ו", "ז", "ח", "ט", "י", "כ", "ל",
           "מ", "נ", "ס", "ע", "פ", "צ", "ק", "ר", "ש", "ת", "ף", "ץ", "ך", "ם"]
...
#  screen.blit(write_image,(0,500))
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEMOTION:
            ...
            if event.key == pygame.K_SPACE:
                ...
                lottery_latter = random.choice(latters)
                latters_font = myfont.render(
                    str(lottery_latter), True, (110, 220, 34))
    ...
    screen.blit(
        cursor_image, (mouse_position[0]-size_x_cursor/2, mouse_position[1]-10))
